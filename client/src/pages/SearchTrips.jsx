...
const SearchTrips = () => {
  ...
  const cities = ["Addis Ababa", "Gondar", "Bahir Dar", "Hawassa", "Dire Dawa", "Arba Minch" , "Jimma"];
...
const getDuration = (start, end) => {
  ...
  <Box mt={4} marginLeft={5} width="80%">
    ...
    {searchResults.map((trip, index) => (
      <Card key={index} sx={{ mb: 3, p: 3, borderRadius: 4, boxShadow: 3 }}>
        <Grid container alignItems="center" justifyContent="space-between">
          {/* Departure */}
          <Grid item xs={4}>
            <Typography fontWeight="bold">{dayjs(trip.departure_date).format("DD MMM").toUpperCase()}</Typography>
